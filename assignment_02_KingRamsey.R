...
## Use `setwd()` if needed
setwd("/home/ramsey/GitHub/dsc520")
...
person_df2 <- read.csv(file = 'data/tidynomicon/person.csv', stringsAsFactors = F)
str(person_df2)
...
person_df <- dbGetQuery(db, 'SELECT * FROM PERSON', stringAsFactors = F)
head(person_df)
