...
set.seed(36912)
binaryk3 <- kmeans(x=binary_data, centers=3)
binaryk5 <- kmeans(x=binary_data, centers=5)
binaryk10 <- kmeans(x=binary_data, centers=10)
binaryk15 <- kmeans(x=binary_data, centers=15)
binaryk20 <- kmeans(x=binary_data, centers=20)
binaryk25 <- kmeans(x=binary_data, centers=25)

# NEED TO COMPUTE THE ACCUARCY
